                        ...
                        <table class="min-w-full divide-y divide-gray-200 border">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-6 py-3 bg-gray-50 text-left">
                                        <span
                                            class="text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Period Covered</span>
                                    </th>
                                    <th class="px-6 py-3 bg-gray-50 text-left">
                                        <span
                                            class="text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Conducted by</span>
                                    </th>
                                    <th class="px-6 py-3 bg-gray-50 text-left">
                                        <span
                            ...
                            <tr class="bg-white">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
                                        ...
                                        <form form action="{{ route('maintenance.destroy', $report->id) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
...
<script>
    function confirmDelete(id) {
        if (confirm('Are you sure you want to delete this report?')) {
            ...
            document.querySelector(`form[action="{{ route('maintenance.destroy', ':id') }}"]`.replace(':id', id)).submit();
        }
    }
