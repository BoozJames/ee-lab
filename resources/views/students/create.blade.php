                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('students.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="srcode" id="srcode"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="extra_name" id="extra_name"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        <div class="mb-4">
                            <label for="colleges" class="block text-sm font-medium text-gray-700">Colleges</label>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="programs" id="programs"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        <div class="mb-4">
                            <label for="courses_array" class="block text-sm font-medium text-gray-700">Courses
                                Array</label>
                            <input type="text" name="courses_array" id="courses_array"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
