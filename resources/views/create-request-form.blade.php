                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                            <a href="#"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <h2 class="text-xl font-semibold text-gray-900">Select Trainer</h2>
                                        <p class="mt-1 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                            Select a trainer (A trainer is a group of items)
                                        </p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <h2 class="text-xl font-semibold text-gray-900">Select Items</h2>
                                        <p class="mt-1 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                            Select the item(s)
                                        </p>
                                    </div>
